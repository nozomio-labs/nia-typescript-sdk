...
export class DefaultService {
     ...
     * @throws ApiError
     */
    public static listOracleHistorySessionsV2OracleHistoryGet(
        limit: number = 20,
        skip?: number,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
     ...
     * @throws ApiError
     */
    public static getOracleHistorySessionV2OracleHistorySessionIdGet(
        sessionId: string,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static oracleResearchStreamV2OracleStreamPost(
        requestBody: OracleResearchRequest,
    ): CancelablePromise<any> {
        return __request(OpenAPI, {
            method: 'POST',
